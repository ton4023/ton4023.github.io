<template>
  <div class="flex md:flex-row flex-col-reverse justify-center items-center">
    <div class="md:w-2/5 mt-20 md:mt-0">
      <div ref="profile" class="text-center">
        <h1 class="font-bold text-4xl font-serif pb-10 text-blue-900">
    ...
    <div class="md:w-3/5 max-h-screen mt-10 md:mt-0">
      <svg
      ...
      >
        ...
        <path
          ...
          fill="#d0cde1"
        ></path>
        <circle cx="498.06371" cy="237.45791" r="65" fill="#f2f2f2"></circle>
        <path
        ...
        <circle
          ...
          fill="#6c63ff"
        ></circle>
        <circle cx="435.8203" cy="15.24386" r="5.61624" fill="#6c63ff"></circle>
        <circle
          cx="455.07573"
          cy="15.24386"
          r="5.61624"
  ...
  <div
    class="w-12 h-12 absolute inset-x-2/4 bottom-0 animate__animated animate__fadeInDown animate__infinite animate__slow"
  >
    <img :src="icon" />
  </div>
</template>
...
<!-- <div
      ...
      :class="[
        scroll === true
          ? '-mt-12 md:-mt-2 -mb-6 md:-mb-2 transform -translate-y-8 scale-100 transition duration-300 ease-linear'
    ...
    >
      <img
        :src="pic"
        alt="profile"
        class="rounded-full ring-4 ring-red-500 ring-opacity-50 ring-offset-2"
      />
    </div> -->