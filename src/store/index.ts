...
const state: RootState = {
  ...
  myAbout: [
    `สวัสดีครับ ผมกำลังหางาน Web Developer เรียนจบระบบสารสนเทศ จาก มทร.ศรีวิชัย แต่งานที่ทำก่อนหน้านี้ เป็นงานที่ทำเกี่ยวกับงานด้านธุรการบัญชี 
    งานประจำวันที่ต้องทำจะมี การเปิดบิลใบส่งสินค้า/บิลใบกำกับภาษี/ใบสั่งซื้อสินค้า 
    ดูแลการเบิกสินค้า จัดทำสต็อคคงเหลือสินค้า สรุปจำนวนเงินที่เซลล์ขายแต่ล่ะวัน และ ทำเงินเดือนพนักงาน ส่งประกันสังคม `,
    `มีพื้นฐานการเขียนโค๊ด พยายามศึกษาการเขียนโค๊ตด้วยตนเอง โดยดูจาก Youtube หรือ อ่านบทความจาก Medium 
    หากมีปัญหาด้านการเขียนโค๊ต ก็หาคำตอบจาก Stack Overflow เพราะคิดว่า มันต้องมีบ้างแหละ ที่เจอปัญหาเหมือนเรา 
    เข้าใจแนวคิดการเขียนโปรแกรมแบบ OOP/MVC ไม่ยึดติดกับภาษาโปรแกรมมิ่ง ปรับเปลี่ยนตามความเหมาะสมของงาน
