...
const state: RootState = {
  ...
  myAbout: [
    `สวัสดีครับ ผมกำลังหางาน Web Developer เรียนจบระบบสารสนเทศ จาก มทร.ศรีวิชัย แต่งานที่ทำก่อนหน้านี้ 
    เป็นงานที่ทำเกี่ยวกับงานด้านธุรการบัญชี งานประจำวันที่ต้องทำจะมี การเปิดบิลใบส่งสินค้า/บิลใบกำกับภาษี/ใบสั่งซื้อสินค้า 
    ดูแลการเบิกสินค้า จัดทำสต็อคคงเหลือสินค้า และ สรุปจำนวนเงินที่เซลล์ขายแต่ล่ะวัน`,
